...
var COLS = "1fr 125px 95px 100px 175px 170px 40px";
...
function renderFilaInsumo(c, categorias) {
  return '<div class="tx-row" style="grid-template-columns:' + COLS + ';">' +
    ...
    '<span class="mobile-th">Unidad</span><input class="mini-input" style="width:100%" list="dl-unidades" value="' + esc(c.unidad) + '" title="Escribe &quot;servicio&quot; si es algo que se paga pero no se compra en ningún lado (diseño, confección, sublimado)." data-action-change="set-cat-campo" data-id="' + c.id + '" data-campo="unidad" />' +
